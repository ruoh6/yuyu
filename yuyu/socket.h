#ifndef __YUYU_SOCKET_H__
#define __YUYU_SOCKET_H__
...
public:
    ...
    static Socket::ptr CreateTCP(yuyu::Address::ptr address);
    static Socket::ptr CreateUDP(yuyu::Address::ptr address);
...
public:
    ...
    static SSLSocket::ptr CreateTCP(yuyu::Address::ptr address);
