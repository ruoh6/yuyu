#ifndef __YUYU_TCP_SERVER_H__
#define __YUYU_TCP_SERVER_H__
...
public:
    ...
    TcpServer(yuyu::IOManager* worker = yuyu::IOManager::GetThis()
            , yuyu::IOManager* io_worker = yuyu::IOManager::GetThis()
            , yuyu::IOManager* accept_worker = yuyu::IOManager::GetThis());

    virtual ~TcpServer();
    virtual bool bind(yuyu::Address::ptr addr, bool ssl = false);
