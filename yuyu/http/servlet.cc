...
int32_t FunctionServlet::handle(yuyu::http::HttpRequest::ptr request
               , yuyu::http::HttpResponse::ptr response
...
ServletDispatch::ServletDispatch()
    ...
    m_default.reset(new NotFoundServlet("yuyu/1.0"));
}

int32_t ServletDispatch::handle(yuyu::http::HttpRequest::ptr request
               , yuyu::http::HttpResponse::ptr response
               , yuyu::http::HttpSession::ptr session) {
...
int32_t NotFoundServlet::handle(yuyu::http::HttpRequest::ptr request
                   , yuyu::http::HttpResponse::ptr response
                   , yuyu::http::HttpSession::ptr session) {
    response->setStatus(yuyu::http::HttpStatus::NOT_FOUND);
    response->setHeader("Server", "yuyu/1.0.0");
