#ifndef __YUYU_HTTP_SERVLET_H__
#define __YUYU_HTTP_SERVLET_H__
...
public:
    ...
    virtual int32_t handle(yuyu::http::HttpRequest::ptr request
                   , yuyu::http::HttpResponse::ptr response
                   , yuyu::http::HttpSession::ptr session) = 0;
...
public:
    ...
    typedef std::function<int32_t (yuyu::http::HttpRequest::ptr request
                   , yuyu::http::HttpResponse::ptr response
                   , yuyu::http::HttpSession::ptr session)> callback;


    FunctionServlet(callback cb);
    virtual int32_t handle(yuyu::http::HttpRequest::ptr request
                   , yuyu::http::HttpResponse::ptr response
                   , yuyu::http::HttpSession::ptr session) override;
private:
    callback m_cb;
};
